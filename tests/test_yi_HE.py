...
TEST_CASES_TO_CURRENCY_EUR = (
    ...
    #(100.00, 'אײן הונדערט אױראָ און נול צענט'),
)

TEST_CASES_TO_CURRENCY_USD = (
    (1.00, 'אײן דאָללאַר און נול צענט'),
    ...
    #(100.00, 'אײן הונדערט דאָללאַר און נול צענט'),
)

TEST_CASES_TO_CURRENCY_GBP = (
    (1.00, 'אײן פּונט און נול פּענץ'),
    ...
    #(100.00, 'אײן הונדערט פּונט און נול פּענץ'),
)

TEST_CASES_TO_CURRENCY_DEM = (
    (1.00, 'אײן מאַרק און נול פּענניק'),
    ...
    #(100.00, 'אײן הונדערט מאַרק און נול פּענניק'),
)
